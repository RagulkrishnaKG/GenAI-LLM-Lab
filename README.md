...
- `experiment.py` - clean, runnable Python code based on the lab manual
- `OUTPUT.md` - the respective sample input/output and result from the manual
...
> Note: Generative model outputs can vary between runs. The output files preserve the sample outputs provided in the laboratory manual.
